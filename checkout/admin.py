...
class CheckoutAdmin(admin.ModelAdmin):
    list_display = ('user', 'email', 'total_price', 'status', 'created_at', 'payment_method', 'transaction_id')
    ...
    fieldsets = (
        (None, {
            'fields': ('user', 'email', 'username_in_game', 'server', 'total_price', 'status', 'payment_method')
        }),
        ('Advanced options', {
            'classes': ('collapse',),
