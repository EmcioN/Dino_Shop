...
urlpatterns = [
    ...
    path('dinosaur/delete/<int:dinosaur_id>/', views.delete_dinosaur, name='delete_dinosaur'),
    path('dinosaur/edit/<int:dinosaur_id>/', views.edit_dinosaur, name='edit_dinosaur'),
